...
# Load csv files
df_exame_raw = pd.read_csv("PRE/dataset_exames.csv", '|',\
                encoding='latin-1')
df_paciente_raw = pd.read_csv("PRE/dataset_pacientes.csv",\
                '|', encoding='latin-1')
